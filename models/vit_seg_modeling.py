...
class Transformer(nn.Module):
    def __init__(self, config, img_size, vis,input_channels):
        ...
        self.embeddings = Embeddings(config, img_size=img_size,in_channels=input_channels)
...
class Generator_B(nn.Module):
    def __init__(self, input_channels=3, output_channels=1, config=CONFIGS['R50-ViT-B_16'], img_size=224, zero_head=False, vis=False):
